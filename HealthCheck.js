...
var HealthCheck_ = (function () {
  ...
  function checkSourceConfig_() {
    const keys = ['BLOG_RSS_URL', 'TILNOTE_PROFILE_URL', 'YOUTUBE_RSS_URL', 'YOUTUBE_CHANNEL_URL', 'LINKEDIN_SOURCE_URLS', 'TPT_SOURCE_URLS', 'IMWEB_SOURCE_URLS', 'TREND_NEWS_SHEET_ID'];
    let count = 0;
